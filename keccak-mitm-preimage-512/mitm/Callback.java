    ...
    //try {
      ...
      for (int i = 0; i < 5; i++) 
        for (int j = 0; j < 5; j++) 
          for (int k = 0; k < 32; k++)
            for (int l = 0; l < 3; l++)  {
                  Pi_initValue[i][j][k][l]  = (int) Math.round(x[3*(32*(5*i+j)+k)+l]);
                }
     for (int i = 0; i < 5; i++) 
        for (int k = 0; k < 32; k++)
          for (int l = 0; l < 4; l++)  {
                CondValue[i][k][l]  = (int) Math.round(x[2400+4*(32*i+k)+l]);
          }
      ...
      for (int round = 0; round < Rounds+1; round++)
        for (int i = 0; i < 5; i++) 
          for (int j = 0; j < 5; j++) 
            for (int k = 0; k < 32; k++)
              for (int l = 0; l < 3; l++)  {
                    DAValue[round][i][j][k][l]  = (int) Math.round(x[3040+3*(32*(5*(5*round+i)+j)+k)+l]);
                  }
      ...
      for (int round = 0; round < Rounds; round++)
	    ...
	    for (int k = 0; k < 32; k++) 
	      for (int l = 0; l < 3; l++)  { 
                DBValue[round][i][j][k][l]  = (int) Math.round(x[2400*Rounds+5440+3*(32*(5*(5*round+i)+j)+k)+l]);
              }
      ...
      for (int round = 0; round < Rounds; round++)
        for (int i = 0; i < 5; i++) 
          for (int j = 0; j < 5; j++) 
            for (int k = 0; k < 32; k++)
                for (int l = 0; l < 2; l++){
                  DC2Value[round][i][j][k][l]  = (int) Math.round(x[2400*Rounds+5440+2400*Rounds+2*(32*(5*(5*round+i)+j)+k)+l]);
                }
      ...
      for (int round = 0; round < Rounds; round++)
        for (int i = 0; i < 5; i++) 
          for (int k = 0; k < 32; k++)
            for (int l = 0; l < 3; l++)  {
                  DPValue[round][i][k][l]  = (int) Math.round(x[6400*Rounds+5440+3*(32*(5*round+i)+k)+l]);
            }
      ...
      for (int round = 0; round < Rounds; round++)
        for (int i = 0; i < 5; i++) 
          for (int k = 0; k < 32; k++)
            for (int l = 0; l < 3; l++)  {
                  DP2Value[round][i][k][l]  = (int) Math.round(x[6880*Rounds+5440+3*(32*(5*round+i)+k)+l]);
            }
      ...
      for (int round = 0; round < Rounds; round++)
        for (int i = 0; i < 5; i++) 
          for (int k = 0; k < 32; k++)
              for (int l = 0; l < 2; l++){
                  DC1Value[round][i][k][l]  = (int) Math.round(x[7360*Rounds+5440+2*(32*(5*round+i)+k)+l]);
              }
      ...
      for (int round = 0; round < Rounds; round++)
        for (int i = 0; i < 5; i++) 
          for (int k = 0; k < 32; k++)
              for (int l = 0; l < 2; l++){
                DC12Value[round][i][k][l]  = (int) Math.round(x[7680*Rounds+5440+2*(32*(5*round+i)+k)+l]);
              }

      for (int i = 0; i < 2; i++) 
        for (int k = 0; k < 32; k++) {
              DomValue[i][k]  = (int) Math.round(x[8000*Rounds+5440+32*i+k]);
          }
      for (int i = 0; i < 3; i++) {
