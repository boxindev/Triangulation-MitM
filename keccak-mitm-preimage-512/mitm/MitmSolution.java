...
public class MitmSolution {
  ...
  public MitmSolution(int Rounds, int objective, int[][][][] Pi_init, int[][][] Cond, int[][][][][] DA, int[][][][][]DB, int[][][][][] DC2, int[][][][] DP, int[][][][] DP2, int[][][][] DC1, int[][][][] DC12, int[][] dom, int[] obj) {
    this.Rounds = Rounds;
    this.objective = objective;
    this.Pi_init = Pi_init;
    this.Cond = Cond;
    this.DA = DA;
    this.DP = DP;
    this.DP2 = DP2;
