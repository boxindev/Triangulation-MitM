...
public class MitmSolutionToTikz {
  ...
  private static final String GreenColor = "green!60";
    private static final String PinkColor = "red";
    private static final String PurpleColor = "red";
  ...
  public String generate() {
    ...
    output += "\\makeatletter\n";
      ...
      int linear_consumered = 0;
      int linear_consumered_c = 0;
      int linear_consumered_d = 0;
      int linear_consumered_t = 0;
    ...
    for (int round = 0; round < mitmSolution.Rounds; round++) {
          ...
          for (int i = 0; i < 4; i++)
            for (int j = 0; j < 3; j++) 
            {
              ...
              if (mitmSolution.DA[round][i][j][k][0] == 1 & mitmSolution.DA[round][i][j][k][1] == 1 & mitmSolution.DA[round][i][j][k][2] == 1)
                output += "\\fill[color="+ GreenColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+18)+") rectangle ++(1,1);\n";
              if (mitmSolution.DA[round][i][j][k][0] == 0 & mitmSolution.DA[round][i][j][k][1] == 1 & mitmSolution.DA[round][i][j][k][2] == 0)
                ...
                if (mitmSolution.DA[round][i][j][k][0] == 0 & mitmSolution.DA[round][i][j][k][1] == 0 & mitmSolution.DA[round][i][j][k][2] == 1)
                    output += "\\fill[color="+ PinkColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+18)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round][i][j][k][0] == 1 & mitmSolution.DA[round][i][j][k][1] == 0 & mitmSolution.DA[round][i][j][k][2] == 1)
	  ...
	  int allred=0;
		...
		allblue++;
          ...
          output += " \\node[align=center] at ("+(5*31+4+4.5)+","+(23*(mitmSolution.Rounds-round)+20.4)+") {\\textbf{\\huge = "+(allred)+"}};\n";
         ...
         {       
          for (int i = 0; i < 4; i++)
           {
              ...
              if (mitmSolution.DP[round][i][k][0] == 1 & mitmSolution.DP[round][i][k][1] == 1 & mitmSolution.DP[round][i][k][2] == 1)
                output += "\\fill[color="+ GreenColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+15)+") rectangle ++(1,1);\n";
              if (mitmSolution.DP[round][i][k][0] == 0 & mitmSolution.DP[round][i][k][1] == 1 & mitmSolution.DP[round][i][k][2] == 0)
               ...
               if (mitmSolution.DP[round][i][k][0] == 0 & mitmSolution.DP[round][i][k][1] == 0 & mitmSolution.DP[round][i][k][2] == 1)
                   output += "\\fill[color="+ PinkColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+15)+") rectangle ++(1,1);\n";
               if (mitmSolution.DP[round][i][k][0] == 1 & mitmSolution.DP[round][i][k][1] == 0 & mitmSolution.DP[round][i][k][2] == 1)
          ...
          {
              //DC1
              if (mitmSolution.DC1[round][i][k][0] == 0 & mitmSolution.DC1[round][i][k][1] == 1) {
                consumered ++;
                  linear_consumered ++;
                  linear_consumered_c ++;
                output += "\\draw[line width=2pt, color=red]("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
              }
              if (mitmSolution.DC1[round][i][k][0] == 1 & mitmSolution.DC1[round][i][k][1] == 1) {
                  consumered ++;
                  output += "\\draw[line width=2pt, color=red]("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+15)+") grid ++(1,1);\n";
              }
          }
        ...
        if (round == 0 & linear_consumered_c > 0) {
            //utput += " \\node[align=center] at ("+(5*31+4+8)+","+(23*(mitmSolution.Rounds-round)+15.4)+") {\\textbf{\\huge + " + (linear_consumered_c) + " LC}};\n";
        }
       ...
       {       
          for (int i = 0; i < 4; i++)
           {
              ...
              if (mitmSolution.DP2[round][i][k][0] == 1 & mitmSolution.DP2[round][i][k][1] == 1 & mitmSolution.DP2[round][i][k][2] == 1)
                output += "\\fill[color="+ GreenColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+13)+") rectangle ++(1,1);\n";
              if (mitmSolution.DP2[round][i][k][0] == 0 & mitmSolution.DP2[round][i][k][1] == 1 & mitmSolution.DP2[round][i][k][2] == 0)
               ...
               if (mitmSolution.DP2[round][i][k][0] == 0 & mitmSolution.DP2[round][i][k][1] == 0 & mitmSolution.DP2[round][i][k][2] == 1)
                   output += "\\fill[color="+ PinkColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+13)+") rectangle ++(1,1);\n";
               if (mitmSolution.DP2[round][i][k][0] == 1 & mitmSolution.DP2[round][i][k][1] == 0 & mitmSolution.DP2[round][i][k][2] == 1)
          ...
          for (int i = 0; i < 4; i++)
           {
              //DC12
              if (mitmSolution.DC12[round][i][k][0] == 0 & mitmSolution.DC12[round][i][k][1] == 1) {
                consumered2 ++;
                linear_consumered ++;
                linear_consumered_d ++;
                output += "\\draw[line width=2pt, color=red]("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+13)+") grid ++(1,1);\n";
              }
               if (mitmSolution.DC12[round][i][k][0] == 1 & mitmSolution.DC12[round][i][k][1] == 1) {
                   consumered2 ++;
                   output += "\\draw[line width=2pt, color=red]("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+13)+") grid ++(1,1);\n";
               }
            }
        ...
        if (round == 0 & linear_consumered_d > 0) {
            //output += " \\node[align=center] at ("+(5*31+4+8)+","+(23*(mitmSolution.Rounds-round)+13.4)+") {\\textbf{\\huge + " + (linear_consumered_d) + " LC}};\n";
        }
      ...
      // DB after theta
            ...
            for (int j = 0; j < 3; j++) 
            {
              if (j==0) {
                ...
                if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                  output += "\\fill[color="+ GreenColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                  ...
                  if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
                      output += "\\fill[color="+ PinkColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
                      output += "\\fill[color="+PurpleColor+"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
              }
              if (j==1) {
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 0)
                  output += "\\fill[color="+WhiteColor+"] ("+(5*k+(i+3)%4)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                  output += "\\fill[color="+RedColor+"] ("+(5*k+(i+3)%4)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                  output += "\\fill[color="+BlueColor+"] ("+(5*k+(i+3)%4)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                  output += "\\fill[color="+ GreenColor +"] ("+(5*k+(i+3)%4)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                  output += "\\fill[color="+GrayColor+"] ("+(5*k+(i+3)%4)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
                      output += "\\fill[color="+ PinkColor +"] ("+(5*k+(i+3)%4)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
                      output += "\\fill[color="+PurpleColor+"] ("+(5*k+(i+3)%4)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";

              }
              if (j==2) {
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 0)
                  output += "\\fill[color="+WhiteColor+"] ("+(5*((k+21)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                  output += "\\fill[color="+RedColor+"] ("+(5*((k+21)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                  output += "\\fill[color="+BlueColor+"] ("+(5*((k+21)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                  output += "\\fill[color="+ GreenColor +"] ("+(5*((k+21)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                  output += "\\fill[color="+GrayColor+"] ("+(5*((k+21)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
                      output += "\\fill[color="+ PinkColor +"] ("+(5*((k+21)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
                      output += "\\fill[color="+PurpleColor+"] ("+(5*((k+21)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") rectangle ++(1,1);\n";
              }
            }
        }
        for (int k = 0; k < 32; k++) {
        ...
        {       
          for (int i = 0; i < 4; i++)
            ...
            {
              //DC2
              if (mitmSolution.DC2[round][i][j][k][0] == 0 & mitmSolution.DC2[round][i][j][k][1] == 1) {
                consumered3 ++;
                linear_consumered ++;
                linear_consumered_t ++;
                output += "\\draw[line width=2pt, color=red]("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") grid ++(1,1);\n";
              }
                if (mitmSolution.DC2[round][i][j][k][0] == 1 & mitmSolution.DC2[round][i][j][k][1] == 1) {
                    consumered3 ++;
                    output += "\\draw[line width=2pt, color=red]("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+9)+") grid ++(1,1);\n";
                }
            }
        ...
        if (round == 0 & linear_consumered_t > 0) {
            //output += " \\node[align=center] at ("+(5*31+4+8)+","+(23*(mitmSolution.Rounds-round)+10.4)+") {\\textbf{\\huge + " + (linear_consumered_t) + " LC}};\n";
        }
        ...
        {       
          for (int i = 0; i < 4; i++)
            for (int j = 0; j < 3; j++) 
            {
              ...
              if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 1)
                output += "\\fill[color="+ GreenColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+5)+") rectangle ++(1,1);\n";
              if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 1 & mitmSolution.DB[round][i][j][k][2] == 0)
                output += "\\fill[color="+GrayColor+"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+5)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 0 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
                    output += "\\fill[color="+ PinkColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j+5)+") rectangle ++(1,1);\n";
                if (mitmSolution.DB[round][i][j][k][0] == 1 & mitmSolution.DB[round][i][j][k][1] == 0 & mitmSolution.DB[round][i][j][k][2] == 1)
            ...
            for (int j = 0; j < 3; j++) 
            {
              if (j==0) {
                ...
                if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                  output += "\\fill[color="+ GreenColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 0)
                  ...
                  if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                      output += "\\fill[color="+ PinkColor +"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                      output += "\\fill[color="+PurpleColor+"] ("+(5*k+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
              }
              if (j==1) {
                if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 0)
                  output += "\\fill[color="+WhiteColor+"] ("+(5*((k+31)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                  output += "\\fill[color="+RedColor+"] ("+(5*((k+31)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 0)
                  output += "\\fill[color="+BlueColor+"] ("+(5*((k+31)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                  output += "\\fill[color="+ GreenColor +"] ("+(5*((k+31)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 0)
                  output += "\\fill[color="+GrayColor+"] ("+(5*((k+31)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                      output += "\\fill[color="+ PinkColor +"] ("+(5*((k+31)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                      output += "\\fill[color="+PurpleColor+"] ("+(5*((k+31)%32)+i)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
              }
              if (j==2) {
                if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 0)
                  output += "\\fill[color="+WhiteColor+"] ("+(5*((k+24)%32)+(i+2)%4)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                  output += "\\fill[color="+RedColor+"] ("+(5*((k+24)%32)+(i+2)%4)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 0)
                  output += "\\fill[color="+BlueColor+"] ("+(5*((k+24)%32)+(i+2)%4)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                  output += "\\fill[color="+ GreenColor +"] ("+(5*((k+24)%32)+(i+2)%4)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 1 & mitmSolution.DA[round+1][i][j][k][2] == 0)
                  output += "\\fill[color="+GrayColor+"] ("+(5*((k+24)%32)+(i+2)%4)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DA[round+1][i][j][k][0] == 0 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                      output += "\\fill[color="+ PinkColor +"] ("+(5*((k+24)%32)+(i+2)%4)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
                  if (mitmSolution.DA[round+1][i][j][k][0] == 1 & mitmSolution.DA[round+1][i][j][k][1] == 0 & mitmSolution.DA[round+1][i][j][k][2] == 1)
                      output += "\\fill[color="+PurpleColor+"] ("+(5*((k+24)%32)+(i+2)%4)+","+(23*(mitmSolution.Rounds-round)+j)+") rectangle ++(1,1);\n";
              }
            }
          output += "\\draw("+(5*k)+","+(23*(mitmSolution.Rounds-round)+18)+") grid ++(4,3);\n";
          output += " \\node[align=center] at ("+(5*k+2)+","+(23*(mitmSolution.Rounds-round)+17)+")[scale=2] {{\\Large z="+k+"}};\n";
	...
	if (mitmSolution.dom[0][k]==1)
      ...
      System.out.print("linear consumed red: ");
      System.out.print(linear_consumered + " = " + linear_consumered_c + " + " +linear_consumered_d + " + " + linear_consumered_t);
      System.out.print("\n");
