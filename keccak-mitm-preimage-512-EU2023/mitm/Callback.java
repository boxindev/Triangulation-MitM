...
public class Callback extends GRBCallback {
    ...
    private MitmSolution getSolution(int solutionNumber, double obj, double[] x) {
        ...
        for (int i = 0; i < 5; i++)
            for (int k = 0; k < 64; k++)
                for (int l = 0; l < 4; l++)  {
                    CondValue[i][k][l]  = (int) Math.round(x[4800+4*(64*i+k)+l]);
                }
        ...
        for (int round = 0; round < Rounds+1; round++)
            for (int i = 0; i < 5; i++)
                for (int j = 0; j < 5; j++)
                    for (int k = 0; k < 64; k++)
                        for (int l = 0; l < 3; l++)  {
                            DAValue[round][i][j][k][l]  = (int) Math.round(x[6080+3*(64*(5*(5*round+i)+j)+k)+l]);
                        }
        ...
        for (int round = 0; round < Rounds; round++)
            for (int i = 0; i < 5; i++)
                for (int j = 0; j < 5; j++)
                    for (int k = 0; k < 64; k++)
                        for (int l = 0; l < 3; l++)  {
                            DBValue[round][i][j][k][l]  = (int) Math.round(x[4800*Rounds+10880+3*(64*(5*(5*round+i)+j)+k)+l]);
                        }
        ...
        for (int round = 0; round < Rounds; round++)
            for (int i = 0; i < 5; i++)
                for (int j = 0; j < 5; j++)
                    for (int k = 0; k < 64; k++)
                        for (int l = 0; l < 2; l++){
                            DC2Value[round][i][j][k][l]  = (int) Math.round(x[4800*Rounds+10880+4800*Rounds+2*(64*(5*(5*round+i)+j)+k)+l]);
                        }
        ...
        for (int round = 0; round < Rounds; round++)
            for (int i = 0; i < 5; i++)
                for (int k = 0; k < 64; k++)
                    for (int l = 0; l < 3; l++)  {
                        DPValue[round][i][k][l]  = (int) Math.round(x[12800*Rounds+10880+3*(64*(5*round+i)+k)+l]);
                    }
        ...
        for (int round = 0; round < Rounds; round++)
            for (int i = 0; i < 5; i++)
                for (int k = 0; k < 64; k++)
                    for (int l = 0; l < 3; l++)  {
                        DP2Value[round][i][k][l]  = (int) Math.round(x[13760*Rounds+10880+3*(64*(5*round+i)+k)+l]);
                    }
        ...
        for (int round = 0; round < Rounds; round++)
            for (int i = 0; i < 5; i++)
                for (int k = 0; k < 64; k++)
                    for (int l = 0; l < 2; l++){
                        DC1Value[round][i][k][l]  = (int) Math.round(x[14720*Rounds+10880+2*(64*(5*round+i)+k)+l]);
                    }
        ...
        for (int round = 0; round < Rounds; round++)
            for (int i = 0; i < 5; i++)
                for (int k = 0; k < 64; k++)
                    for (int l = 0; l < 2; l++){
                        DC12Value[round][i][k][l]  = (int) Math.round(x[15360*Rounds+10880+2*(64*(5*round+i)+k)+l]);
                    }

        for (int i = 0; i < 2; i++)
            for (int k = 0; k < 64; k++) {
                DomValue[i][k]  = (int) Math.round(x[16000*Rounds+10880+64*i+k]);
            }
        for (int i = 0; i < 3; i++) {
