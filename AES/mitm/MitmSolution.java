...
public class MitmSolution {
  ...
  public MitmSolution(int Rounds, int keyRounds, int regime, int fRounds, int bRounds, int Startr, int objective, int[][][][][] Af, int[][][][][] SBf, int[][][][][] MCf, int[][][][] DCf, int[][][][] DCfAK, int[][][] Guesslf, int[][][][][] Ab, int[][][][][] SBb, int[][][][][] MCb, int[][][][] DCb, int[][][][] DCbAK, int[][][] Guesslb, MitMSolutionKey Key, int[][] dom, int[] obj) {
    this.Rounds = Rounds;
    ...
    this.DCf = DCf;
    this.DCfAK = DCfAK;
    this.Guesslf = Guesslf;
    this.Ab = Ab;
    this.SBb = SBb;
    this.MCb = MCb;
    this.DCb = DCb;
    this.DCbAK = DCbAK;
    this.Guesslb = Guesslb;
    this.dom = dom;
    this.obj = obj;
    this.Key = Key;
  }
