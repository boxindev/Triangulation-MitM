...
public class MitMKey {
  ...
  public MitMKey(final GRBModel model, final int Rounds, final int keyRounds, final int regime, final int Startr) throws GRBException {
    ...
    RK = new GRBVar[Rounds+1][4][4][2][2];
  ...
  public void create192() throws GRBException {
	...
	//DCS
      ...
      addfourXor(S[round][0][0], DCS[round][0][0], S[round-1][3][0], S[round-1][3][1], S[round-1][3][2], Sboxout[round][0]);
      addthreeXor(S[round][0][1], DCS[round][0][1], S[round-1][3][1], S[round-1][3][2], Sboxout[round][0]);
      ...
      addfourXor(S[round][1][2], DCS[round][1][2], S[round-1][4][2], S[round-1][4][3], S[round-1][5][0], Sboxout[round][1]);
      addthreeXor(S[round][1][3], DCS[round][1][3], S[round-1][4][3], S[round-1][5][0], Sboxout[round][1]);
      ...
      addfourXor(S[round][3][3], DCS[round][3][3], S[round-1][0][3], S[round-1][1][0], S[round-1][1][1], Sboxout[round][2]);
      addthreeXor(S[round][4][0], DCS[round][4][0], S[round-1][1][0], S[round-1][1][1], Sboxout[round][2]);
      ...
      addfourXor(S[round][5][1], DCS[round][5][1], S[round-1][2][1], S[round-1][2][2], S[round-1][2][3], Sboxout[round][3]);
      addthreeXor(S[round][5][2], DCS[round][5][2], S[round-1][2][2], S[round-1][2][3], Sboxout[round][3]);
  ...
  public MitMSolutionKey getValue() throws GRBException {
    int[][][][][] RKValue = new int[Rounds+1][4][4][2][2];
